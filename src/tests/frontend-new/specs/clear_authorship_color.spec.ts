...
test("makes text clear authorship colors and checks it can't be undone", async function ({
	page,
}) {
...
test("clears authorship when first line has line attributes", async function ({
	page,
}) {
