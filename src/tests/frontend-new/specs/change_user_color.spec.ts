...
test.describe("change user color", function () {
	test("Color picker matches original color and remembers the user color after a refresh", async function ({
		page,
	}) {
	...
	test("Own user color is shown when you enter a chat", async function ({
		page,
	}) {
