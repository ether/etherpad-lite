...
import type { APool } from "../../../node/types/PadType";
...
const testCases = [
	...
	},
	{
		...
		wantAlines: ["*0*4*6*7+1+3", "*0*5*6*8+1+3", "*0*4*6*8+1+3"],
		wantText: ["*one", "*1.1", "*two"],
	},
	{
	...
	},
	{
		...
		wantAlines: ["*0*2*6+1+1", "*0*2*6+1+1", "+3", "+3"],
	...
	},
	{
		...
		noteToSelf:
			"<p></p>should create a line break but not break numbering -- This is what I can't get working!",
		disabled: true,
	},
	{
