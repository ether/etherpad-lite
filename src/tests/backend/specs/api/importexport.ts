...
const testImports: MapArrayType<any> = {
	...
	"nonelistiteminlist #3620": {
		...
		wantHTML:
			'<!DOCTYPE HTML><html><body><ul class="bullet">test<li>FOO</ul><br></body></html>',
		wantText: "\ttest\n\t* FOO\n\n",
		disabled: true,
	},
	"whitespaceinlist #3620": {
		...
		wantHTML:
			'<!DOCTYPE HTML><html><body><ul class="bullet"><li>FOO</ul><br></body></html>',
		wantText: "\t* FOO\n\n",
	},
	prefixcorrectlinenumber: {
		input:
			"<html><body><ol><li>should be 1</li><li>should be 2</li></ol></body></html>",
		wantHTML:
			'<!DOCTYPE HTML><html><body><ol start="1" class="number"><li>should be 1</li><li>should be 2</ol><br></body></html>',
		wantText: "\t1. should be 1\n\t2. should be 2\n\n",
	},
	prefixcorrectlinenumbernested: {
		input:
			"<html><body><ol><li>should be 1</li><ol><li>foo</li></ol><li>should be 2</li></ol></body></html>",
		wantHTML:
			'<!DOCTYPE HTML><html><body><ol start="1" class="number"><li>should be 1<ol start="2" class="number"><li>foo</ol><li>should be 2</ol><br></body></html>',
		wantText: "\t1. should be 1\n\t\t1.1. foo\n\t2. should be 2\n\n",
	},
  ...
  */
	ignoreAnyTagsOutsideBody: {
		...
		input:
			"<html><head><title>title</title><style></style></head><body>empty<br></body></html>",
	...
	indentedListsAreNotBullets: {
		...
		input:
			'<html><body><ul class="indent"><li>indent</li><li>indent</ul></body></html>',
		wantHTML:
			'<!DOCTYPE HTML><html><body><ul class="indent"><li>indent</li><li>indent</ul><br></body></html>',
		wantText: "\tindent\n\tindent\n\n",
	},
	lineWithMultipleSpaces: {
		...
		wantHTML:
			"<!DOCTYPE HTML><html><body>Text with more than one space.<br><br></body></html>",
	...
	lineWithMultipleNonBreakingAndNormalSpaces: {
		...
		description:
			"non-breaking space should be preserved, but can be replaced when it",
		input:
			"<html><body>Text&nbsp;with&nbsp; more&nbsp;&nbsp;&nbsp;than   &nbsp;one space.<br></body></html>",
		wantHTML:
			"<!DOCTYPE HTML><html><body>Text with&nbsp; more&nbsp;&nbsp; than&nbsp; one space.<br><br></body></html>",
		wantText: "Text with  more   than  one space.\n\n",
	},
	...
	multipleNonBreakingSpaceBetweenWords: {
		...
		input:
			"<html><body>&nbsp;&nbsp;word1&nbsp;&nbsp;word2&nbsp;&nbsp;&nbsp;word3<br></body></html>",
		wantHTML:
			"<!DOCTYPE HTML><html><body>&nbsp; word1&nbsp; word2&nbsp;&nbsp; word3<br><br></body></html>",
	...
	spacesAfterNewline: {
		...
		input:
			"<!doctype html><html><body>something<br>             something<br></body></html>",
		wantHTML:
			"<!DOCTYPE HTML><html><body>something<br>something<br><br></body></html>",
		wantText: "something\nsomething\n\n",
	},
	spacesAfterNewlineP: {
		description: "Collapse spaces that follow a paragraph",
		input:
			"<!doctype html><html><body>something<p></p>             something<br></body></html>",
		wantHTML:
			"<!DOCTYPE HTML><html><body>something<br><br>something<br><br></body></html>",
		wantText: "something\n\nsomething\n\n",
	},
	spacesAtEndOfLine: {
		description: "Collapse spaces that preceed/follow a newline",
		input:
			"<html><body>something            <br>             something<br></body></html>",
		wantHTML:
			"<!DOCTYPE HTML><html><body>something<br>something<br><br></body></html>",
		wantText: "something\nsomething\n\n",
	},
	spacesAtEndOfLineP: {
		...
		input:
			"<html><body>something            <p></p>             something<br></body></html>",
		wantHTML:
			"<!DOCTYPE HTML><html><body>something<br><br>something<br><br></body></html>",
		wantText: "something\n\nsomething\n\n",
	},
	...
	collapseSpacesInsideElements: {
		...
		input:
			"<html><body>Need <span> more </span> space<i>  s </i> !<br></body></html>",
		wantHTML:
			"<!DOCTYPE HTML><html><body>Need more space<em> s </em>!<br><br></body></html>",
		wantText: "Need more space s !\n\n",
	},
	collapseSpacesAcrossNewlines: {
		description:
			"Newlines and multiple spaces across newlines should be collapsed",
		input: `
      <html><body>Need
          <span> more </span>
          space
	...
	multipleNewLinesAtBeginning: {
		description:
			"Multiple new lines and paragraphs at the beginning should be preserved",
		input:
			"<html><body><br><br><p></p><p></p>first line<br><br>second line<br></body></html>",
		wantHTML:
			"<!DOCTYPE HTML><html><body><br><br><br><br>first line<br><br>second line<br><br></body></html>",
		wantText: "\n\n\n\nfirst line\n\nsecond line\n\n",
	},
	multiLineParagraph: {
		description:
    ...
    <p>
      ...
      п р с т у ф х ц ч ш щ ю я ь
		...
		wantHTML:
			"<!DOCTYPE HTML><html><body>&#1072; &#1073; &#1074; &#1075; &#1169; &#1076; &#1077; &#1108; &#1078; &#1079; &#1080; &#1110; &#1111; &#1081; &#1082; &#1083; &#1084; &#1085; &#1086; &#1087; &#1088; &#1089; &#1090; &#1091; &#1092; &#1093; &#1094; &#1095; &#1096; &#1097; &#1102; &#1103; &#1100;<br><br></body></html>",
		wantText:
...
ь</p>
		...
		wantHTML:
			"<!DOCTYPE HTML><html><body>&#1072; &#1073; &#1074; &#1075; &#1169; &#1076; &#1077; &#1108; &#1078; &#1079; &#1080; &#1110; &#1111; &#1081; &#1082; &#1083; &#1084; &#1085; &#1086;<br>multiple<br>&nbsp;&nbsp; lines<br>&nbsp;in<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; pre<br><br>&#1087; &#1088; &#1089; &#1090; &#1091; &#1092; &#1093; &#1094; &#1095; &#1096; &#1097; &#1102; &#1103; &#1100;<br><br></body></html>",
		wantText:
			"а б в г ґ д е є ж з и і ї й к л м н о\nmultiple\n   lines\n in\n      pre\n\nп р с т у ф х ц ч ш щ ю я ь\n\n",
	},
	preIntroducesASpace: {
...
<pre>preline
		...
		wantHTML:
			"<!DOCTYPE HTML><html><body>1<br>preline<br><br><br></body></html>",
		wantText: "1\npreline\n\n\n",
	},
