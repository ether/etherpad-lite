...
describe(__filename, () => {
	...
	describe("v1.3.0", () => {
		it("change is attributed to given authorId", async () => {
			const oldHead = pad.head;
		...
		it("authorId can be omitted", async () => {
			const oldHead = pad.head;
