...
function padDiffHTML (pad, fromRev, toRev){      
  //check parameters
...
padDiffHTML.prototype._isClearAuthorship = function(changeset){
  //unpack
...
padDiffHTML.prototype._createClearAuthorship = function(rev, callback){
  var self = this;
...
padDiffHTML.prototype._createClearStartAtext = function(rev, callback){
  var self = this;
...
padDiffHTML.prototype._getChangesetsInBulk = function(startRev, count, callback) {
  var self = this;
...
padDiffHTML.prototype._addAuthors = function(authors) {
  var self = this;
...
padDiffHTML.prototype._createDiffAtext = function(callback) {
  var self = this;
  var bulkSize = 100;
    ...
    async.whilst(
      ...
      function (callback) {
        ...
        self._getChangesetsInBulk(rev,bulkSize,function(err, changesets, authors){
          ...
          //add the authors to the padDiffHTML authorArray
...
padDiffHTML.prototype.getHtml = function(callback){
  //cache the html
  if(this._html != null){
...
padDiffHTML.prototype.getAuthors = function(callback){
  var self = this;
...
padDiffHTML.prototype._extendChangesetWithAuthor = function(changeset, author, apool) {  
  //unpack
  var unpacked = Changeset.unpack(changeset);  
...
padDiffHTML.prototype._createDeletionChangeset = function(cs, startAText, apool) {
