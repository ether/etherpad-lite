...
Scroll.prototype._triggerScrollWithAnimation = function (
	$elem,
	pixelsToScroll,
	durationOfAnimationToShowFocusline,
) {
...
Scroll.prototype.getVisibleLineRange = function (rep) {
	...
	const start = rep.lines.search(
		(e) => self._getLineEntryTopBottom(e, obj).bottom > viewport.top,
	);
	...
	let end = rep.lines.search(
		(e) => self._getLineEntryTopBottom(e, obj).top >= viewport.bottom,
	);
