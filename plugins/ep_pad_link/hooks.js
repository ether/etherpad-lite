...
exports.eejsBlock_editbarMenuLeft = function (hookName, context, cb) {
	const button = eejs.require("ep_pad_link/templates/editbarButtons.ejs", {}, module);
...
exports.eejsBlock_body = function (hookName, context, cb) {
	context.content = context.content + eejs.require("ep_pad_link/templates/modals.ejs", {}, module);

	return cb();
}

exports.eejsBlock_scripts = function (hookName, context, cb) {
	context.content = context.content + eejs.require("ep_pad_link/templates/scripts.ejs", {}, module);

	return cb();
}

exports.eejsBlock_styles = function (hookName, context, cb) {
	context.content = context.content + eejs.require("ep_pad_link/templates/styles.ejs", {}, module);
