...
if [ ! $NODE_V_MINOR = "v0.8" ] && [ ! $NODE_V_MINOR = "v0.8" ] && [ ! $NODE_V_MINOR = "v0.6" ]; then
  echo "You're running a wrong version of node, you're using $NODE_VERSION, we need v0.6.x or v0.8.x or v0.9.x" >&2
  exit 1 
fi
