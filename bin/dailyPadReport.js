/*
 * This is a debug tool. It creates a report of pad activity and displays data by day/date
 * Most of this source code comes from padREport.js
 */
...
if (process.argv.length !== 3 && process.argv.length !== 4) {
  console.error("Use: node bin/dailyPadReport.js $PADID $threshold");
